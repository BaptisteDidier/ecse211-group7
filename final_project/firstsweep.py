...
def convert_node_data_tuple(node_list, tuple_list):
    ...
    for node1, node2 in edges: #this is tuple value ex (0,1)
        for output_node_num, output_length, output_angle in output_file:
            if node1 == output_node_num:
                length1, angle1 = output_length, output_angle
            if node2 == output_node_num:
                length2, angle2 = output_length, output_angle
